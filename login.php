...
<!-- add a horizontal menu bar --> 
	...
	<?php
            ...
            if (isset($_POST['login']) && !empty($_POST['usname'])  //referred from stackoverflow
               && !empty($_POST['pwrd'])) {
    ...
    <!--create login form-->
        <div class="container">
            ...
            <form method="POST" class="form1" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <label for="username">Enter your username :</label><br>
                     ...
                     <input type="password" id="pwd" name="pwrd" placeholder="password" required><br><br><br>
		...
		<center><?php  echo $msg; ?><br>
		    ...
		    login as Vehicle Owner &nbsp<a href="login_vehicleowner.php">login</a>
		</center>
