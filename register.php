...
<!-- add a horizontal menu bar --> 
	...
	<div class="container">
    <center> 
        <h2> Customer Registration</h2> <!-- reffered from labsheets-->
    </center>
    ...
    <form class="form1" action="submitRegistration.php" method="POST" onsubmit="return checkPassword()">
	    ...
	    <br>
		<div><p align="center">Register as vehicle owner <a href="register_vehicleowner.php">Register</a></p></div><br>
			
		<div><p align="center">Already have an account <a href="login.php">Login</a></p></div>
